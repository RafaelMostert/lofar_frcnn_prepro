...
DATASET_NAME='inference_1field_DR2_kafka'
SAMPLE_LEN=10 # Limit number of sources to this number. Set very high to have no limit
...
CATALOGUE_PATH="/home/rafael/data/mostertrij/data/catalogues"
export PROJECTPATH=/home/rafael/data/mostertrij/lofar_frcnn_prepro # location of project
...
python $PROJECTPATH/imaging_scripts/make_cutout_objects.py $TRAINING_MODE $SAMPLE_LEN \
...
#sleep 30
#rsync -a /home/rafael/data/mostertrij/data/frcnn_images/inference_$DATASET_NAME lgm4:/data1/mostertrij/data/frcnn_images
#rsync -a /home/rafael/data/mostertrij/data/cache/segmentation_maps* lgm4:/data1/mostertrij/data/cache
